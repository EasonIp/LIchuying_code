...
#
# Generated: 2017-03-12 16:09:13.774
...
QUARTUS_PROJECT_DIR = D:/ZXOPEN2017/DE2/class/led18

# the simulation directory is a subdirectory of the PTF directory
SIMDIR = $(QUARTUS_PROJECT_DIR)/led18_cpu_sim
...
hex: $(QUARTUS_PROJECT_DIR)/program.hex $(QUARTUS_PROJECT_DIR)/data.hex
.PHONY: hex
...
$(QUARTUS_PROJECT_DIR)/program.hex: $(ELF)
	@echo Post-processing to create $(notdir $@)
	elf2hex $(ELF) 0x00002000 0x2FFF --width=32 $(QUARTUS_PROJECT_DIR)/program.hex --create-lanes=0

$(QUARTUS_PROJECT_DIR)/data.hex: $(ELF)
	@echo Post-processing to create $(notdir $@)
	elf2hex $(ELF) 0x00003000 0x3FFF --width=32 $(QUARTUS_PROJECT_DIR)/data.hex --create-lanes=0
...
generated_app_clean:
	$(RM) $(QUARTUS_PROJECT_DIR)/program.hex
	$(RM) $(QUARTUS_PROJECT_DIR)/data.hex
