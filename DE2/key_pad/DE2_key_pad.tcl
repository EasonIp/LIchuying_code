...
# 4x4 key_pad
set_location_assignment PIN_P24		-to		col[0]     
set_location_assignment PIN_R24		-to		col[1]     
set_location_assignment PIN_T22		-to		col[2]     
set_location_assignment PIN_T24		-to		col[3]     
set_location_assignment PIN_T18		-to		row[0]     
set_location_assignment PIN_T20		-to		row[1]     
set_location_assignment PIN_U25		-to		row[2]     
set_location_assignment PIN_U24		-to		row[3]  
